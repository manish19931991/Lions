  ...
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground source={image} resizeMode="cover" style={{ width: "100%", flex:1}}>
        <View style={{ justifyContent: "center", alignItems: "center", marginTop: 158 }}>
          {<Image
            source={require('../google/onboarding_2.png')}
          />}
        </View>
        <View style={{ justifyContent: "center", alignItems: "center", marginTop: 32 }}>
          <Text style={{ fontSize: 36, color: "#FFFFFF", fontWeight: "bold", }}>Explore more</Text>
        </View>
        <View style={{alignSelf:"center"}}>
          <Text style={{ fontSize: 36, color: "#FFFFFF", fontWeight: "bold", }}>business</Text>
        </View>
        ...
        {/* <View style={{marginTop:32,marginLeft:31,marginRight:31,}}> */}
          <TouchableOpacity onPress={() => navigation.navigate('Home')} style={{ marginHorizontal: 10,
              borderRadius: 5,
              height:60,
              marginHorizontal:30,
