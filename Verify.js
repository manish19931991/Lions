        ...
        <View style={{ flex: 1 }}>
            <ImageBackground source={image} resizeMode="cover" style={{ width: width, flex: 1, height: height }}>
                ...
                <View style={{ alignItems: "flex-start", marginLeft: 24, marginTop: 36 }}>
                    <Text style={{ color: "#EEEEEE", fontSize: 28, fontFamily: 'Roboto-Bold', fontWeight: "bold" }}>Verify phone </Text>
                    <Text style={{ color: "#EEEEEE", fontSize: 28, fontFamily: 'Roboto-Bold', fontWeight: "bold" }}>number</Text>
                </View>
